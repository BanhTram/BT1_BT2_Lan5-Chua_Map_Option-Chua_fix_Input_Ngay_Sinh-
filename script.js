...
var myController = function ($scope) {
    ...
    //     var lop = {
    //         tenLop: "Lop 10A" + (i + 1), thuoc: "Lop 10"
    //     };
    //     $scope.lop_x.push(lop);
    // }
    $scope.totalItems = $scope.lop_x.length;
    $scope.currentPage = 1;
    ...
    $scope.saveAdd = function (hoTen, tuoi, lop) {
        // var c = new Date().getFullYear() - tuoi.getFullYear();
        var c = new Date().getFullYear() - new Date(tuoi).getFullYear();
        $scope.hocSinh.push({ hoTen: hoTen, tuoi: c, lop: lop });
        $scope.change_Main_Add = true;
        $scope.main = true;
